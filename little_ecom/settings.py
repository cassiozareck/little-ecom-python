"""
Django settings for little_ecom project.
...
SECRET_KEY = "django-insecure-#45_nwm5v#bzwm_n-zrju=jj4pvmh^@l4hp+ck51^3)p+)lale"
...
WSGI_APPLICATION = "little_ecom.wsgi.application"
